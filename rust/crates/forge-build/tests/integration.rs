...
use forge_build::{BuildEngine, CompileRequest, EngineConfig, RunConfig, RunEvent};
use tokio::sync::mpsc;
...
fn repo_root() -> PathBuf {
    // crate dir = <root>/rust/crates/forge-build
...
"#,
    ...
    assert!(
        stdout.contains("forge-build-ok 42"),
